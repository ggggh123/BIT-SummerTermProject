...
ev::protocol::ResponseEnvelope RequestDispatcher::ok(const QString &requestId, const QString &message, const QJsonValue &data) const
{
    return {requestId, true, QStringLiteral("OK"), message, data};
}

ev::protocol::ResponseEnvelope RequestDispatcher::fail(const QString &requestId, const QString &code, const QString &message) const
{
