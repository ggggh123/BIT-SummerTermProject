...
- [ ] **Step 1: Write failing count, range and determinism tests**
...
- [ ] **Step 3: Implement fixed stations and relational seed**
...
- [ ] **Step 4: Implement hourly demand generation**
...
- [ ] **Step 1: Write failing safe-path and artifact tests**
...
- [ ] **Step 3: Implement a pure, clock-injected engine**
...
- [ ] **Step 3: Implement client using `ev_protocol`**
...
- [ ] **Step 1: Add an offscreen smoke test target**
