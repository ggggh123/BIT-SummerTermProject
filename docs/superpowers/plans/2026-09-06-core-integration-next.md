...
**2026-09-06 执行记录：** 模拟器/数据 `6e44c18+6a69d0b`、管理端 `9fc9919+237e2b0` 已独立审查通过并组合；管理 Qt 启动/刷新、模拟器网络/窗口与黄金工具回归均通过。实际 SimulatorWindow 对真实服务端的跨模块补充测试继续执行；没有将 fake-server 单测冒充该联调。
