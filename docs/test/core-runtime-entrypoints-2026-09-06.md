...
> 最新复验：最终生产候选 `2876575` 已由主控独立验证，构建成功，CTest **32/32（39.34 秒）**，其中脚本 **121 passed**、真实三程序 **2 passed**，数据库 **15 passed**；黄金摘要未变。最终修复 F-I1/M1 独立复审均关闭。下文保留各阶段历史证据，不以旧结果代替新候选；完整最终记录见[运行交付评审](../review/core-runtime-entrypoints-review-2026-09-06.md#最终候选全量证据)。
