...
for part2_target in /usr/local/ev-part2 /usr/local/hadoop-3.2.1 /usr/local/hadoop /usr/local/spark-3.5.7-bin-hadoop3 /usr/local/spark /usr/local/bin/ev-part2 /usr/local/bin/python3.10 /etc/profile.d/ev-part2.sh; do
